...
import { HeroBanner } from "@/components/read/HeroBanner";
import { FeaturedBooks } from "@/components/read/FeaturedBooks";
import { BookPreviewModal } from "@/components/read/BookPreviewModal";
...
export default function ReadPage() {
  ...
  return (
    <main>
      <HeroBanner />
      <FeaturedBooks onPreview={setSelectedBookId} />
      <BookPreviewModal bookId={selectedBookId} onClose={() => setSelectedBookId(null)} />
    </main>
  );
}
